...
export const profileCopy: Record<Locale, ProfileCopy> = {
  ...
  en: {
    ...
    about: {
      ...
      asideLabel: "Zestful & Grateful",
      aside:
        "I care deeply about my work and about life beyond it. I enjoy sports, music, animals, and all the things that make life feel good. I believe every encounter has meaning - even those without a destination.",
    },
    contact: {
      eyebrow: "LET'S TALK",
